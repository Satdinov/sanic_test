...
Revision ID: 6658bfeb579b
Revises: 8d1c442f3444
Create Date: 2022-06-21 12:34:41.438282
...
revision = '6658bfeb579b'
down_revision = '8d1c442f3444'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('orders_works', postgresql.ENUM('design', 'soldering', 'revision', name='works'), server_default='Soldering', nullable=False, comment="Сustomer's work"),
