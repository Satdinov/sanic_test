...
Revision ID: 8ea7bd9b6d37
Revises: 9b391aac8ab5
Create Date: 2022-06-21 12:17:36.027058
...
revision = '8ea7bd9b6d37'
down_revision = '9b391aac8ab5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('works', postgresql.ENUM('design', 'soldering', 'revision', name='works'), server_default='Design', nullable=False, comment='Order Status'),
    ...
    op.add_column('users', sa.Column('subject', postgresql.ENUM('FizFace', 'UrFace', name='user_subject'), server_default='Fiz', nullable=False, comment='User subject'))
