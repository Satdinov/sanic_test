...
Revision ID: 7499bbd6d02b
Revises: 6658bfeb579b
Create Date: 2022-06-21 12:36:17.176378
...
revision = '7499bbd6d02b'
down_revision = '6658bfeb579b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('status', postgresql.ENUM('Processing', 'Accepted', 'Confirmed', 'Operation', 'Sent', 'Completed', name='order_status'), server_default='Processing', nullable=True, comment='Order Status'),
    sa.Column('orders_works', postgresql.ENUM('design', 'soldering', 'revision', name='works'), server_default='Soldering', nullable=True, comment="Сustomer's work"),
    ...
    op.create_index(op.f('ix_orders_orders_works'), 'orders', ['orders_works'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_orders_orders_works'), table_name='orders')
